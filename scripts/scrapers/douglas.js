  ...
  try {
    ...
    const items = await page.evaluate(() => {
        ...
        return cards.map(card => {
            ...
            const saleEl = card.querySelector('.price__sale, [class*="price--promo"], [class*="promo-price"], .price-promo, .price-sales');
            const origEl = card.querySelector('.price__regular, [class*="price--base"], [class*="old-price"], .price-old, .price-standard');
